...
<header x-data="{ open: false }"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        <nav class="hidden md:flex items-center gap-1 sm:gap-2 text-sm font-medium">
            ...
            @auth
                <a href="{{ route('wallet.index') }}" class="px-3 py-2 rounded-md {{ request()->routeIs('wallet.*') ? 'text-indigo-400 bg-slate-900' : 'text-slate-300 hover:text-white hover:bg-slate-700' }}">المحفظة</a>
    ...
    >
        ...
        @auth
            <a href="{{ route('wallet.index') }}" class="block px-3 py-2 rounded-md {{ request()->routeIs('wallet.*') ? 'text-indigo-400 bg-slate-900' : 'text-slate-300 hover:text-white hover:bg-slate-700' }}">المحفظة</a>
            <a href="{{ route('notifications.index') }}" class="block px-3 py-2 rounded-md {{ request()->routeIs('notifications.*') ? 'text-indigo-400 bg-slate-900' : 'text-slate-300 hover:text-white hover:bg-slate-700' }}">الإشعارات</a>
